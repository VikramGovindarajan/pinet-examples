...
IPS.Properties.Double TLAB1 = DHSNZ1LAB.GetPropertyFromPropID("UN,5,-1,-1,-1.Temperature") as IPS.Properties.Double;
IPS.Properties.Double TLAB2 = DHSNZ1LAB.GetPropertyFromPropID("SE,5,-1,-1,-1.Temperature") as IPS.Properties.Double;
TLAB=0.5*(TLAB1+TLAB2);
RCL = RCL + TC2LAB1*(TLAB-TOREF);

IPS.Properties.Double TNALAB = PipeNZ1LAB.GetPropertyFromPropID("TotalTemperatureNode2") as IPS.Properties.Double;
RNA = RNA + TC3LAB1*(TNALAB-TOREF);

IPS.Properties.Double TDL3 = DHSNZ1LAB.GetPropertyFromPropID("UN,2,-1,-1,-1.Temperature") as IPS.Properties.Double;
IPS.Properties.Double TDL4 = DHSNZ1LAB.GetPropertyFromPropID("SE,2,-1,-1,-1.Temperature") as IPS.Properties.Double;
TDL6=0.5*(TDL3+TDL4);
QDNL=TDL6/TOREF;
...
// upper axial blanket
IPS.Properties.Double TUAB1 = DHSNZ1UAB.GetPropertyFromPropID("UN,5,-1,-1,-1.Temperature") as IPS.Properties.Double;
IPS.Properties.Double TUAB2 = DHSNZ1UAB.GetPropertyFromPropID("SE,5,-1,-1,-1.Temperature") as IPS.Properties.Double;
TUAB = 0.5*(TUAB1+TUAB2);
RCL = RCL + TC2UAB1*(TUAB-TOREF);

IPS.Properties.Double TNAUAB = PipeNZ1UAB.GetPropertyFromPropID("TotalTemperatureNode2") as IPS.Properties.Double;
RNA = RNA + TC3UAB1*(TNAUAB-TOREF);

IPS.Properties.Double TDU3 = DHSNZ1UAB.GetPropertyFromPropID("UN,2,-1,-1,-1.Temperature") as IPS.Properties.Double;
IPS.Properties.Double TDU4 = DHSNZ1UAB.GetPropertyFromPropID("SE,2,-1,-1,-1.Temperature") as IPS.Properties.Double;
TDU6=0.5*(TDU3+TDU4);
QDNU=TDU6/TOREF;
