...
circuit1.add_BC("bc2","node0",'msource',3200.)
circuit1.add_BC("bc3","node0",'T',452.1)

# series1 for temp vs time
    
global series1
series1 = csv_reader("temp_SST_500.csv")
def fun2(time,delt):
    y = series1(time)
    return y
...
global series2
series2 = csv_reader("power_SST_500.csv")
def fun3(time,delt):
...
solver_settings.conv_crit_ht = 1.E-6
