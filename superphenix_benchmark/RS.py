...
#___________________________________________________________________________________________________________________________________________________
#Boundary condition RS

circuit1.add_BC("bc1","node3",'P',1.5E5)
circuit1.add_BC("bc2","node0",'msource',10400)
circuit1.add_BC("bc3","node0",'T',672.7)

# series1 for temp vs time
   
global series1
series1 = csv_reader("temp_RS_300.csv")
def fun2(time,delt):
    y = series1(time)
    return y
...
global series2
series2 = csv_reader("power_RS_300.csv")
def fun3(time,delt):
