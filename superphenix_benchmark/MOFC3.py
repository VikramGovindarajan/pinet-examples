...
global series1
series1 = csv_reader("temp_MOFC3_250.csv")
def fun2(time,delt):
    y = series1(time)
    return y
...
global series2
series2 = csv_reader("power_MOFC3_250.csv")
def fun3(time,delt):
...
action_setup.Action(None,None,fun_cp)  
