...
layer143 = hslab14.add_layer(thk_elem=2.570E-3,thk_cros=H_fer,nnodes=3,darea=P1_pelt*H_fer,solname='MOX13',sollib="User",heat_input= 5.642E-3*Pow_IC,AFF=[0.616,0.257,0.127])
...
layer223 = hslab22.add_layer(thk_elem=2.570E-3,thk_cros=H_fer,nnodes=3,darea=P2_pelt*H_fer,solname='MOX13',sollib="User",heat_input= 0.0053895*Pow_OC,AFF=[0.141,0.257,0.602])
...
#___________________________________________________________________________________________________________________________________________________
#Boundary condition MOFC2

circuit1.add_BC("bc1","node3",'P',1.5E5)
circuit1.add_BC("bc2","node0",'msource',6360.)
circuit1.add_BC("bc3","node0",'T',657.9)

# series1 for temp vs time   
   
global series1
series1 = csv_reader("temp_MOFC2_250.csv")
def fun2(time,delt):
    y = series1(time)
    return y
...
global series2
series2 = csv_reader("power_MOFC2_250.csv")
def fun3(time,delt):
